...
fr = open("src/data/beibao0.in")    # 打开要读取的txt文件
list = []
i = 0
...
fr = open("src/data/beibao1.in")    # 打开要读取的txt文件
list=[]
i=0
for line in fr.readlines():
    list.append(line.strip().split(' '))
...
fr = open("src/data/beibao3.in")    # 打开要读取的txt文件
list=[]
i=0
for line in fr.readlines():
    list.append(line.strip().split(' '))
...
fr = open("src/data/beibao4.in")    # 打开要读取的txt文件
list=[]
i=0
for line in fr.readlines():
    list.append(line.strip().split(' '))
...
fr = open("src/data/beibao5.in")    # 打开要读取的txt文件
list=[]
i=0
for line in fr.readlines():
    list.append(line.strip().split(' '))
...
fr = open("src/data/beibao6.in")    # 打开要读取的txt文件
list=[]
i=0
for line in fr.readlines():
    list.append(line.strip().split(' '))
...
fr = open("src/data/beibao7.in")    # 打开要读取的txt文件
list=[]
i=0
for line in fr.readlines():
    list.append(line.strip().split(' '))
...
fr = open("src/data/beibao8.in")    # 打开要读取的txt文件
list=[]
i=0
for line in fr.readlines():
    list.append(line.strip().split(' '))
...
fr = open("src/data/beibao9.in")    # 打开要读取的txt文件
list=[]
i=0
for line in fr.readlines():
    list.append(line.strip().split(' '))
